...
To configure the application, you need to set up a `.env` file in the root directory of your project. This file should contain the following environment variables:
...
Replace `your_tmdb_api_key_here` and `your_tmdb_api_read_access_token_here` with your actual API key and read access token from TMDB. Adjust `APP_HOST`, `APP_PORT`, and `DEBUG` as needed for your environment.
